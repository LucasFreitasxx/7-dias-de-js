...
<html lang="pt-BR">
  ...
  <body>
    <script>
      ...
      while (acao !== "sair") {
        acao = prompt(
          "Você deseja 'adicionar', 'remover' um item da lista ou 'sair'?"
        );
        ...
        if (acao === "adicionar") {
          ...
          categoria = prompt(
            "Em qual categoria essa comida se encaixa: 'frutas', 'laticinios', 'doces' ou 'congelados'?"
          );
          ...
          categoria = prompt(
            "De qual categoria você deseja remover um item: 'frutas', 'laticinios', 'doces' ou 'congelados'?"
          );
          let listaCategoria;
          ...
          if (listaCategoria.length === 0) {
            ...
            let itemRemover = prompt(
              `Itens em ${categoria}: ${listaCategoria.join(
                ", "
            ...
            if (index !== -1) {
              ...
              alert(
                `Item removido! Lista atualizada de ${categoria}: ${listaCategoria.join(
                  ", "
                )}`
              );
            } else {
